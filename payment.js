function showpopUp(){ 
    ...
    var data="Card-Number :- 123412341234, Date :- 12/24 , CVVnumber :- 123,  Name :- Nazir Hussain";
    alert(data)
}
...
function onchance(){
    ...
    name="Nazir Hussain";
       ...
       if(number.length==12&&date=="12/24"&&cvv==123&&name=="Nazir Hussain"){
